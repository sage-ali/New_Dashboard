<div class="sticky-top bg-dark mt-2" id="footer">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 px-5 text-light">
        <p class="col-md-8 mb-0 text-muted">© 2022 Company, Inc</p>

        <a href="#" class="col-md-4 d-flex align-items-center justify-content-end mb-3 mb-md-0 me-md-auto link-light text-light text-decoration-none">
